// Shared base styles used across all classic-themed pages
const LOGO_STYLES = 'img.site-logo { display: block; width: min(100%, 540px); height: auto; margin: 0 0 12px; }';
...
// Classic view dark/light theme CSS custom properties
const CLASSIC_THEME_VARS = `
    html.theme-light {
...
// Classic main page: event list, filters, chips, email draft, calendar
const CLASSIC_PAGE_STYLES = `
