...
const events = [
  {
    ...
    Online: 'FALSE',
    tags: ['AI', 'Hackathon', 'Founder', 'Tech'],
  ...
  },
  {
    ...
    Online: 'FALSE',
    tags: ['AI', 'Hackathon', 'Developer', 'Startup', 'Tech'],
  ...
  },
  {
    ...
    Online: 'FALSE',
    tags: ['AI', 'HealthTech', 'Developer', 'Tech'],
  ...
  },
  {
    ...
    start_datetime: '2026-03-19T17:30:00.000-05:00',
    Online: 'FALSE',
    tags: ['Tech', 'Networking', 'Founder', 'Startup'],
...
async function run() {
  const { data, error } = await supabase
    .from(table)
    .insert(events)
    .select('title,start_datetime,eventUrl,tags,image_url,location');
